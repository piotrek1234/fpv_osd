...
// Voltage divider
#define voltage_1s 0.48828125          // For SimpleOSD, I have used 1.82 - the formula gives 1.86. Test with a multimeter 
#define voltage_2s 0.9765625
#define voltage_3s 1.49443655 
...
#define rssi_cal 0.48828125 
#define rssi_min 0 // Minimum RSSI-value. Will be voltage * 205. 0.5 volt = 103. You can set this to zero and just read the min value and max value
...
#define show_gps_coordinates_altitude 0
...
#define volt_alarm_ 350 // 100 = 1 volt
...
#if (video_system == 0)
  // PAL
  //#define toplinetext -31
  //#define toplinenumbers -41
  #define butlinenumbers 261
  //#define timer_line -242
  //#define gps_nmea_line -22
  //#define summaryline -92
  #define update_buffers 20
  #define current_calc_line 282
#else 
  //NTSC
...
#define mux_batVoltage ADMUX = 1 | (1<<REFS0) |(0<<REFS1);
#define mux_rssi ADMUX = (0<<MUX3) | (0<<MUX2) | (0<<MUX1) | (1<<MUX0) | (1<<REFS0) |(0<<REFS1);
#define mux_batVoltage2 ADMUX = 2 | (1<<REFS0) |(0<<REFS1);
#define mux_batVoltage3 ADMUX = 3 | (1<<REFS0) |(0<<REFS1);
